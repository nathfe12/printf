...
int print_string(va_list types, char buffer[], int flags, int widdth, int precision, int size);
int print_percent(va_list types, char buffer[], int flags, int width, int precision, int size);

/*Fucntions to print numbers*/
...
int print_hexa(va_list, char map_to[], char buffer[], int flags, char flag_ch, int width, int precision, int size);

/*Function to print non variable characters*/
